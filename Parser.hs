...
happyExpList = Happy_Data_Array.listArray (0,135) ([52768,32786,0,0,0,46072,4,0,0,0,11490,1,0,16384,32768,19256,0,4,0,57346,5839,0,1024,11774,1,0,52768,32786,19256,57856,300,0,0,0,0,0,11490,1,12416,0,32768,19256,65024,812,16384,0,49664,0,0,0,63488,1211,52768,18,1024,57856,300,45960,4,0,0,0,8192,12,0,0,4,0,0,0
	])
...
action_19 (9) = happyShift action_18
